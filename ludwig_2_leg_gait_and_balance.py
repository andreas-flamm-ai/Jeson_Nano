...
def lift_leg(leg, opposite_leg):
    ...
    smooth_move(opposite_leg['ankle_roll'], 90, 70)  # Lean toward support leg
    smooth_move(opposite_leg['hip_yaw'], 90, 100)    # Rotate torso slightly

    # Lift active leg
    smooth_move(leg['knee'], 90, 45)
    smooth_move(leg['ankle_pitch'], 90, 120)
